...
//   fillColor2?: string;
//   fillColor3?: string;
//   href1: Href<string | object>;
//   href2: Href<string | object>;
// }
...
//   const cardHeight = height * 0.45; // 45% of the screen height
//   const cardPadding = 25; // Fixed padding

//   return (
//     <View style={className`bg-gray-50 rounded-tl-2xl rounded-tr-2xl h-[${cardHeight}px] w-full p-[${cardPadding}px] absolute bottom-0 left-0 right-0 flex`}>
//       <Text style={className`text-[30px] font-bold mb-2`}>
//         {mainText}{' '}
//         <Text style={className`text-blue-600`}>{lastText}</Text>
//       </Text>
//       <Text style={className`text-[14px] mb-4 font-normal leading-[1.5]`}>
//         {body}
//       </Text>
